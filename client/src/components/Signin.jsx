        ...
        <div className="auth-card glass-panel" style={{ padding: "44px 32px", maxWidth: "420px" }}>
          ...
          <form onSubmit={handleSubmit} className="auth-form" style={{ marginTop: "20px" }}>
            ...
            <div className="form-group">
              ...
              <input type="password" id="password" name="password" className="glass-input" value={formData.password} onChange={handleChange} required placeholder="Enter your password" />
            </div>
          ...
          <Link to="/forgot-password" className="need-help-link" style={{ marginTop: "20px" }}>
            Forgot your password? <span style={{ color: "var(--accent-blue)" }}>Reset it</span>
          </Link>
          ...
          <div className="auth-footer" style={{ marginTop: "28px" }}>
            <p>Don't have an account? <Link to="/signup" style={{ color: "var(--accent-blue)", fontWeight: "bold" }}>Sign up</Link></p>
          </div>
        </div>
      </motion.div>
