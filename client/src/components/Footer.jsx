        ...
        <div className="footer-content">
          <div style={{ paddingRight: "40px" }}>
            ...
            <div style={{ display: "flex", gap: "16px", marginTop: "24px" }}>
              <a href="https://github.com/DhruvRupala" target="_blank" rel="noopener noreferrer" style={{ color: "var(--text-secondary)", padding: "8px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.05)", transition: "all 0.3s" }} onMouseOver={(e) => Object.assign(e.currentTarget.style, { color: "var(--accent-blue)", background: "rgba(56, 189, 248, 0.1)", borderColor: "rgba(56, 189, 248, 0.3)" })} onMouseOut={(e) => Object.assign(e.currentTarget.style, { color: "var(--text-secondary)", background: "rgba(255,255,255,0.03)", borderColor: "rgba(255,255,255,0.05)" })}><Github size={18} /></a>
              <a href="https://x.com/greatRD13" target="_blank" rel="noopener noreferrer" style={{ color: "var(--text-secondary)", padding: "8px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.05)", transition: "all 0.3s" }} onMouseOver={(e) => Object.assign(e.currentTarget.style, { color: "var(--accent-blue)", background: "rgba(56, 189, 248, 0.1)", borderColor: "rgba(56, 189, 248, 0.3)" })} onMouseOut={(e) => Object.assign(e.currentTarget.style, { color: "var(--text-secondary)", background: "rgba(255,255,255,0.03)", borderColor: "rgba(255,255,255,0.05)" })}><Twitter size={18} /></a>
              <a href="https://www.linkedin.com/in/dhruvrupala/" target="_blank" rel="noopener noreferrer" style={{ color: "var(--text-secondary)", padding: "8px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", border: "1px solid rgba(255,255,255,0.05)", transition: "all 0.3s" }} onMouseOver={(e) => Object.assign(e.currentTarget.style, { color: "var(--accent-blue)", background: "rgba(56, 189, 248, 0.1)", borderColor: "rgba(56, 189, 248, 0.3)" })} onMouseOut={(e) => Object.assign(e.currentTarget.style, { color: "var(--text-secondary)", background: "rgba(255,255,255,0.03)", borderColor: "rgba(255,255,255,0.05)" })}><Linkedin size={18} /></a>
            </div>
          </div>
